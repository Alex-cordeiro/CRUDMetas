    ...
    public class ServicoService : IServicoService
    {
        ...
        public IEnumerable<ServicoDTO> FindAll()
        {
            var servicosRetornados = from servicos in _metasContext.Servicos
                                          ...
                                          join tiposMetas in _metasContext.TiposEntradasMetas on servicos.Tipo equals tiposMetas.Id
        ...
        {
            var servicoParaInsercao = new Servico(servicodto.IdEmpresa, servicodto.IdDepartamento, servicodto.IdSetor, servicodto.IdVendedor, servicodto.Valor, servicodto.DataValidade, servicodto.Tipo, servicodto.Codigo, servicodto.Cpf);
