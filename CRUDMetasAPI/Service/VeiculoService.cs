    ...
    public class VeiculoService : IVeiculoService
    {
        ...
        public IEnumerable<VeiculoDTO> FindAll()
        {
            var veiculosRetornados = from veiculos in _metasContext.Veiculos
                                   ...
                                   join departamentos in _metasContext.Departamentos on veiculos.FilialId equals departamentos.Id
        ...
        public bool Insert(VeiculoDTO veiculodto)
        {
            var veiculoParaInsercao = new Veiculo(veiculodto.IdEmpresa, veiculodto.IdDepartamento, veiculodto.IdSetor,veiculodto.IdVendedor, veiculodto.Familia, veiculodto.Quantidade, veiculodto.Valor, veiculodto.DataValidade);
